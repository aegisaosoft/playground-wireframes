...
const mockIdeas: IdeaCard[] = [
  {
    ...
    postedBy: { name: 'Alex Dev', avatar: '/avatars/default-avatar.png' },
    interestCount: 23,
    commentCount: 8,
    isInterested: false,
    isSaved: false,
  ...
  },
  {
    ...
    postedBy: { name: 'Sarah Wellness', avatar: '/avatars/default-avatar.png' },
    interestCount: 45,
    commentCount: 12,
    isInterested: true,
    isSaved: true,
  ...
  },
  {
    ...
    postedBy: { name: 'Maria Santos', avatar: '/avatars/default-avatar.png' },
    interestCount: 31,
    commentCount: 15,
    isInterested: false,
    isSaved: false,
