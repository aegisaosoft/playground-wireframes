...
const mockIdeas: IdeaCard[] = [
  {
    ...
    postedBy: { name: 'Alex Dev', avatar: '/swfault_awatar.png' },
    interestCount: 23,
    commentCount: 8,
    isInterested: false,
    isSaved: false,
  ...
  },
  {
    ...
    postedBy: { name: 'Sarah Wellness', avatar: '/swfault_awatar.png' },
    interestCount: 45,
    commentCount: 12,
    isInterested: true,
    isSaved: true,
  ...
  },
  {
    ...
    postedBy: { name: 'Maria Santos', avatar: '/swfault_awatar.png' },
    interestCount: 31,
    commentCount: 15,
    isInterested: false,
    isSaved: false,
