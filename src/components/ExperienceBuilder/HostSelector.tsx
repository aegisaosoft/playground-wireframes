...
import { User, Plus, Upload, X, Building2 } from 'lucide-react';
    ...
    <div className="space-y-4">
      ...
      <div className="p-3 bg-gradient-dark rounded-lg border border-white/10">
        <p className="text-xs text-muted-foreground">
          💡 <strong>Personal:</strong> Host as yourself with your profile name
        </p>
        <p className="text-xs text-muted-foreground mt-1">
          🏢 <strong>Brand:</strong> Create a business profile for professional hosting
        </p>
      </div>
    </div>
  );
